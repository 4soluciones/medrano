...
urlpatterns = [
    ...
    path('payments/periods/update/', login_required(modal_payment_period_update), name='modal_payment_period_update'),
    path('payments/periods/update-save/', login_required(update_payment_period), name='update_payment_period'),
